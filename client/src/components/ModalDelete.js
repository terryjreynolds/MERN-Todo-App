...
class ModalDelete extends Component {
  ...
  render() {
    ...
    return (
      <form
        className={
          this.props.showModalDelete ? "showModalDelete" : "hideModalDelete"
        }
      ...
      >
        ...
        <input
          ...
          ref={this.textInput}
        />
        <button class="accDeleteButton">Submit</button>
        <button
          class="accDeleteButton"
          type="button"
          onClick={this.modalDeleteUpdate}
        >
          Cancel
        </button>
      </form>
